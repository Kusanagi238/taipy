...
class ExcelDataNode(DataNode, _FileDataNodeMixin, _TabularDataNodeMixin):
    ...
    def _read_as(self, path: str):
        try:
            ...
            user_provided_sheet_names = properties.get(self.__SHEET_NAME_PROPERTY)
            if user_provided_sheet_names is None:
                user_provided_sheet_names = []
            elif isinstance(user_provided_sheet_names, (list, tuple, set)):
