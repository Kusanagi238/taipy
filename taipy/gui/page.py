...
class Page:
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.set_style(t.cast(t.Optional[t.Dict[str, t.Dict[str, t.Any]]], kwargs.get("style", None)))
        self._script_paths(t.cast(t.Optional[t.Union[str, t.List[str]]], kwargs.get("script_paths", None)))
